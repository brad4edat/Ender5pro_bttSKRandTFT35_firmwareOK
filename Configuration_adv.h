...
//#define INPUT_SHAPING_Z
    ...
    #define SHAPING_FREQ_X  17.0        // (Hz) The default dominant resonant frequency on the X axis.
...
// LCD Print Progress options. Multiple times may be displayed in turn.
  ...
  #define PRINT_PROGRESS_SHOW_REMAINING_TIME
  ...
  #define POWER_LOSS_RECOVERY
    ...
    #define POWER_LOSS_HOMING  // home the printer before resuming to achive correct resume position if extruder was move during power lost
    #define POWER_LOSS_MENU   // show the power loss menu on the lcd
    ...
    //#define BACKUP_POWER_SUPPLY           // Backup power / UPS to move the steppers on power-loss
      ...
      #define POWER_LOSS_RETRACT_LEN   1.5 // (mm) Length of filament to retract on fail
      #endif
...
#define RETRACT_MENU_ITEM                 // Fwretractions menu activation in lcd menu
  #define FWRETRACT_AUTORETRACT             // Override slicer retractions
  #if ENABLED(FWRETRACT_AUTORETRACT)
    #define MIN_AUTORETRACT             0.1 // (mm) Don't convert E moves under this length
    #define MAX_AUTORETRACT             1.5
  #endif
...
#define ADVANCED_PAUSE_FEATURE
  ...
  #define FILAMENT_UNLOAD_PURGE_DELAY       9000  // (ms) Delay for the filament to cool after retract.
